class PermissionService
  ...
  def authorized?
    ...
    if user.platform_admin?
      return true if controller == "api/v1/orders" && action.in?(%w(index show create update destroy))
      return true if controller == "api/v1/items" && action.in?(%w(index show create update destroy))
      return true if controller == "api/v1/stores" && action.in?(%w(index show create update destroy))
