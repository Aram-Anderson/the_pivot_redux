	...
	describe 'validations' do
		describe 'invalid attributes' do
			it 'is invalid without a title' do
				...
				store = create(:store)
				item = category.items.create(description: "number one", price: 8.00, image: one_url, store: store)
			...
			it 'is invalid without a description' do
				...
				one_url = "http://pandathings.com/wp-content/uploads/2016/10/onesie-6-300x300.png"
				store = create(:store)
				item = category.items.create(title: "Funsie Onesie", price: 8.00, image: one_url, store: store)
				expect(item).to be_invalid
			end
			...
			it 'is invalid without a price' do
				...
				one_url = "http://pandathings.com/wp-content/uploads/2016/10/onesie-6-300x300.png"
				store = create(:store)
				item = category.items.create(title: "Funsie Onesie",  description: "number one", image: one_url, store: store)
				expect(item).to be_invalid
			end
			...
			it 'is invalid without a unique title' do
				...
				one_url = "http://pandathings.com/wp-content/uploads/2016/10/onesie-6-300x300.png"
				item_one = category.items.create(title: "Funsie Onesie", description: "number one", price: 8.00, image: one_url, store: store)
				item_two = category.items.create(title: "Funsie Onesie", description: "other", price: 9.00, image: two_url, store: store)
		...
		describe 'valid attributes' do
			...
			it 'condition can be set to retired' do
				...
				one_url = "http://pandathings.com/wp-content/uploads/2016/10/onesie-6-300x300.png"
				store = create(:store)
				item_one = category.items.create(title: "Funsie Onesie", description: "number one", price: 8.00, image: one_url, condition: 'retired', store: store)
