  ...
  describe 'realtionships' do
	...
	describe "instance methods" do
		it "can return total price of items" do
			...
			category = Category.create(title: "Animals", slug: "animals")
			one_url = "http://pandathings.com/wp-content/uploads/2016/10/onesie-6-300x300.png"
			item_1 = order.items.create(title: "Funsie Onesie", description: "number one", price: 8.00, image: one_url, category_id: 1, store: store)
			item_2 = order.items.create(title: "Funsie Twosie", description: "number two", price: 22.00, image: one_url, category_id: 1, store: store)
